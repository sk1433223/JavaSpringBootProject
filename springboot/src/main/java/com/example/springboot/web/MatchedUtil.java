...
public class MatchedUtil {
    ...
    public static void main(String[] args) {
        ...
        String idStr = "61243019970409193X";
        boolean b = matchedIdCardUtils(idStr);
        System.out.println(b);

        String emailStr = "id_for_yy@qq.com";
        boolean b1 = matchedEmailUtils(emailStr);
     ...
     * @param idCard 身份证号
     */
    public static boolean matchedIdCardUtils(String idCard) {
